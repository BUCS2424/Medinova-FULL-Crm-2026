...
async def generate_location_page_on_demand(loc_name: str, loc_type: str, state_name: str, state_slug: str) -> str:
    ...
    try:
        ...
        cat_display = {
            ...
            "Respiratory Equipment":       {"icon": "wind",            "gradient": "from-sky-500 to-sky-600",     "subtitle": "CPAP, BiPAP, oxygen concentrators"},
            "Orthopedic / Orthotics":      {"icon": "bone",            "gradient": "from-lime-500 to-lime-600",   "subtitle": "Braces for back, knee, ankle, wrist"},
            "Hospital Beds & Accessories": {"icon": "bed",             "gradient": "from-rose-500 to-rose-600",   "subtitle": "Hospital beds, mattresses, rails"},
            ...
            "Pain Management / Therapeutic":{"icon": "zap",            "gradient": "from-purple-500 to-purple-600","subtitle": "TENS units, therapy devices"},
            "Emergency / Monitoring":      {"icon": "alert-triangle",  "gradient": "from-orange-500 to-red-500",  "subtitle": "AEDs, monitors, oxygen systems"},
            "Lifts / Transfer Equipment":  {"icon": "arrow-up-down",   "gradient": "from-green-500 to-emerald-600","subtitle": "Patient lifts, transfer aids"},
            "Enteral Nutrition":           {"icon": "utensils",        "gradient": "from-pink-500 to-pink-600",   "subtitle": "Feeding tubes, pumps, formulas"},
            "Urology / Ostomy":            {"icon": "droplets",        "gradient": "from-teal-500 to-teal-600",   "subtitle": "Catheters, ostomy supplies"},
            "Prosthetics":                 {"icon": "hand",            "gradient": "from-violet-500 to-violet-600","subtitle": "Limb prosthetics, sockets, liners"},
            "CPAP/BiPAP Accessories":      {"icon": "wind",            "gradient": "from-sky-400 to-blue-500",    "subtitle": "Masks, tubing, headgear, filters"},
            "Pediatric DME":               {"icon": "baby",            "gradient": "from-pink-400 to-rose-500",   "subtitle": "Pediatric medical equipment"},
            "Bariatric Equipment":         {"icon": "activity",        "gradient": "from-amber-500 to-orange-500","subtitle": "Heavy-duty medical equipment"},
